...
logger_kwargs = dict(output_dir='data/test_0', exp_name='test_0')

td3_pytorch(env_fn=env_fn, ac_kwargs=ac_kwargs, steps_per_epoch=1500, epochs=250, logger_kwargs=logger_kwargs)